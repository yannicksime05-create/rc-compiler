...
enum class ASTNodeType {
    ...
    BOOL_LIT_NODE, CHAR_LIT_NODE, INT_LIT_NODE, DECIMAL_LIT_NODE, STRING_LIT_NODE, ARRAY_LIT_NODE,
    ...
    DO_WHILE_STMT_NODE, FOR_STMT_NODE, RANGE_FOR_STMT_NODE, RETURN_STMT_NODE, DECL_STMT_NODE,
    PRINT_STMT_NODE, BREAK_STMT_NODE, CONTINUE_STMT_NODE,
